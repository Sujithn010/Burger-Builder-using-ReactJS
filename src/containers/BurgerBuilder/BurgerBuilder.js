...
export class BurgerBuilder extends Component {
    ...
    render () {
        ...
        let burger = this.props.error?<p>Can't fetch the ingredients</p>:<Spinner/>;
        if(this.props.ings){
            burger = 
            (<Aux>
                ...
                <BuildControls 
                    ...
                    purchasable = {!this.updatedIngredientHandler(this.props.ings)}
...
const mapDispatchToProps = dispatch => {
    return{
        ...
        onInitIngredients: ()=>dispatch(actions.initIngrerdients()),
